...
class ActorAssociationsRepository {
  ActorAssociationsRepository(this._source);
  ...
  Future<MappingRule> create({
    ...
    final raw = await _source.mappingCreate(_type, {
  ...
  Future<MappingRule> update({
    ...
    final raw = await _source.mappingUpdate(_type, id, {
      'mapped_value': mappedValue,
      'original_values': originalValues,
      'scope': _scope,
    });
  ...
  Future<ActorAssocPreview> previewSource(
    ...
    final raw = await _source.actorExternalSyncPreview({
  ...
  Future<String> startMixedPreviewSession(String actorName) async {
    final raw = await _source.mixedExternalSyncPreviewStart({
  ...
  Future<MixedActorPreviewSession> getMixedPreviewSession(String taskId) async {
    final raw = await _source.mixedExternalSyncPreviewSession(taskId);
