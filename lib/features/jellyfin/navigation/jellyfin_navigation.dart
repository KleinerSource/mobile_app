...
Future<void> openJellyfinItem(BuildContext context, MediaBrowserItem item) async {
...
/// 与页面按钮保持一致的非阻塞导航调用。
void openJellyfinItemUnawaited(BuildContext context, MediaBrowserItem item) {
