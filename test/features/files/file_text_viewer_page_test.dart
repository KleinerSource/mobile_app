...
import 'package:omm/features/files/file_text_viewer_page.dart';
...
void main() {
  ...
  testWidgets('未保存返回时可以取消或放弃修改', (tester) async {
    ...
    await tester.pumpAndSettle();
    expect(find.byType(FileTextViewerPage), findsOneWidget);

    await tester.tap(find.byIcon(Icons.arrow_back));
    await tester.pumpAndSettle();
    await tester.tap(find.text('放弃修改'));
    await tester.pumpAndSettle();
    expect(find.byType(FileTextViewerPage), findsNothing);
  });
