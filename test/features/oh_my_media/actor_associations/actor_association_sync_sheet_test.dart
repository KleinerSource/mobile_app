...
//   - test/features/oh_my_media/actor_associations/actor_association_sync_sheet_test.dart
//   - test/features/oh_my_media/actor_associations/actor_associations_test.dart
...
class _PendingPreviewRepository extends ActorAssociationsRepository {
  _PendingPreviewRepository()
    : super(OmmMediaOperationsAdapter(ApiClient(Dio())));
...
// ==================== 原 test/features/oh_my_media/actor_associations/actor_associations_test.dart ====================
void _main_1() {
...
void main() {
  group('actor_association_sync_sheet', _main_0);
  group('actor_associations', _main_1);
}
